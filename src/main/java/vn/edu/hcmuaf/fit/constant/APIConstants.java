...
public class APIConstants {
    ...
    public static String FACEBOOK_REDIRECT_URL = "http://localhost:8080/TTLTWeb_war/login-facebook";
    ...
    public static String GOOGLE_REDIRECT_URI = "http://localhost:8080/TTLTWeb_war/login-google";
