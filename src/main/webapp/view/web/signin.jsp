        ...
        <div class="container">
            ...
            <div class="signin-right " id="a-sign">
                <form action="login?action=login" method="post">
                    ...
                    <br>
                    <div>
                        <a href="https://www.facebook.com/dialog/oauth?client_id=5842543845823968&redirect_uri=http://localhost:8080/TTLTWeb_war_exploded/login-facebook">   <button type="button" class="btn btn-sm btn-outline-primary" >Login with Facebook <i class="fa fa-facebook-square"></i></button></a>
...
<script>
    ...
    <%--            console.log(response);--%>
    <%--            window.location.href = 'login?action=Face&name=' + response.name + '&email=' + response.email + '&id=' + response.id+'&avatar=' + response.avatar;--%>
    <%--        });--%>
    <%--    }--%>

    <%--    window.fbAsyncInit = function () {--%>
    <%--        FB.init({--%>
    <%--            appId: '525154373073693',--%>
    <%--            cookie: true,--%>
    <%--            xfbml: true,--%>
    <%--            version: 'v16.0'--%>
    <%--        });--%>
