          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <% for (BookingModel booking :
                      BookingDAO.getListBookingByStatus(user.getId())) {
                if(booking.getStatus_booking()==2){
              %>
              <div class="row">
                ...
                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                  <!-- Data -->
                  <p><strong><%=booking.getName() %></strong></p>


                  <p>Ngày hẹn: <%=booking.getDate_booking() %></p>
                  <p>Tình trạng: <%=booking.getStatus_booking() %></p>
                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                  <!-- Data -->
                  <p>Số lượng: <%=booking.getQuantity() %></p>
                  <p><strong>Giá: <%=booking.getPrice() %></strong></p>
