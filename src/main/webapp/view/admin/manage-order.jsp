            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        ...
                        <div class="col-sm-2">
                            <a href="manage-order?type=exportExcel" class="btn" type="button" title="Xuất dữ liệu" style="line-height: 0px;border: 1px solid #000000; font-size: 13px; padding: 5px 10px"
