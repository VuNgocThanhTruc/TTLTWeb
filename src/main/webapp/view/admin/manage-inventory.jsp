                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">
                            ...
                            <div class="row element-button">
                                ...
                                <div class="col-sm-2">
                                    <a href="export-excel?type=exportProductInStockExcel" class="btn" type="button" title="Xuất dữ liệu"
                        ...
                        <div class="tab-pane">
                            ...
                            <div class="row element-button">
                                ...
                                <div class="col-sm-2">
                                    <a href="export-excel?type=exportProductOutOfStockExcel" class="btn" type="button" title="Xuất dữ liệu"
                                       style="line-height: 0px;border: 1px solid #000000; font-size: 13px; padding: 5px 10px"
                                    ><i class='bx bxs-file-export'></i> Xuất Excel</a>
                                </div>
                            </div>
